...
last_send_time = 0
send_interval = 1  # Send data every 1 second
...
webcam_stream = VideoStream(2, "Webcam").start()
webcam2_stream = VideoStream(1, "Webcam2").start()
...
roi_webcam_2 = (0, 480, 700, 300)  # left lane
